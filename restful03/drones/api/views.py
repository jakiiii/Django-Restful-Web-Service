...
from drones.api.serializers import DroneCategorySerializer, DroneSerializer, PilotSerializer, PilotCompetitionSerializer

from drones.api import custompermission
...
class ApiRoot(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response({
            'drone-category': reverse(DroneCategoryList.name, request=request),
