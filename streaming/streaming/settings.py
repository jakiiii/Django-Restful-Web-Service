...
SECRET_KEY = 'django-insecure-(4_2()vs_25dseidmtbpl5&ey&(y&8+azs8ks(xi5z^mt9!a3w'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),  # common 5 to 15 minutes
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),    # common 14 days
